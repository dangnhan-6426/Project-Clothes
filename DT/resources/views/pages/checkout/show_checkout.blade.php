						...
						<div class="bill-to">
							...
							<div class="form-one">
								<form action="{{URL::to('/save-checkout-customer')}}" method="POST">
									...
									<input type="text" name="shipping_address" placeholder="Địa chỉ vận chuyển">
									<input type="text" name="shipping_phone" placeholder="Số điện thoại">
									<textarea name="shipping_notes"  placeholder="Ghi chú đơn hạng của bạn" rows="16"></textarea>
